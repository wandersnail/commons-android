 ...
 * <li>{@link #resumeDownload(long...)} onShow download. need resumeDownload(long...) method in {@link DownloadManager}</li>
 * </ul>
 * RequestPro
 * <ul>
...
public class DownloadMgrPro {
    ...
    public DownloadMgrPro(DownloadManager downloadManager) {
    ...
    public int pauseDownload(long... ids) {
        ...
        try {
            return (Integer) pauseDownload.invoke(downloadManager, (Object) ids);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
     ...
     * @return if status of downloadId is {@link DownloadManager#STATUS_PAUSED}, return
     *         {@link #getPausedReason(long)}
     *         if status of downloadId is {@link DownloadManager#STATUS_FAILED}, return {@link #getErrorCode(long)}
     *         if status of downloadId is neither {@link DownloadManager#STATUS_PAUSED} nor
    ...
    /**
     * get paused reason
     * @return if status of downloadId is {@link DownloadManager#STATUS_PAUSED}, return one of
